...
public class znpayGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[] {"sys_auth_user","sys_stat"}); // 需要生成的表

        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.agri");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return "D:/aaa/com/agri/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
        // 调整 impl 生成目录
        focList.add(new FileOutConfig("/templates/serviceImpl.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return "D:/aaa/com/agri/service/impl/" + tableInfo.getEntityName() + "ServiceImpl.java";
            }
        });
